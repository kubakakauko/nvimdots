...
local remap = require("custom.configs.me.util").remap
...
local bundles = {
  vim.fn.glob(
    home .. "/Documents/GitHub/java-debug/com.microsoft.java.debug.plugin/target/com.microsoft.java.debug.plugin-*.jar"
  ),
}
...
local config = {
    ...
    java = {
      ...
      configuration = {
        runtimes = {
          {
            name = "JavaSE-17",
            path = home .. "/Library/Java/JavaVirtualMachines/jdk-17.jdk/Contents/Home",
          },
          {
            name = "JavaSE-18",
            path = home .. "/Library/Java/JavaVirtualMachines/jdk-20.jdk/Contents/Home",
          },
          -- {
          --   name = "JavaSE-11",
  ...
  cmd = {
    home .. "/Library/Java/JavaVirtualMachines/jdk-20.jdk/Contents/Home/bin/java",
